...
function renderCardForTablet(info, name) {
  ...
  setTimeout(() => { Notiflix.Notify.success(`HELLO, You see EVENTS only ${name}`) }, 300)
  setTimeout(() => { Notiflix.Notify.info('👈 BUT, You Can write or Say KEYWORD, and see events only you want') }, 4000)
}
