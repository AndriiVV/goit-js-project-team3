...
async function fetchUrl(kewyord, code) {
  try {
    const response = await fetch(
      `https://app.ticketmaster.com/discovery/v2/events.json?keyword=${kewyord}&countryCode=${code}&source=Ticketmaster&apikey=841T1YMOPnVKBAAycVhND0Lj4GpnyoMw`,
    );
...
fetch(
  `https://app.ticketmaster.com/discovery/v2/events/G5v0Zpsu6Edy5/images.json?apikey=841T1YMOPnVKBAAycVhND0Lj4GpnyoMw`,
)
  .then(res => res.json())
